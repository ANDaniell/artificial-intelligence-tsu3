...
# Проверка наличия файла книги
book_path = "book.txt"
if not os.path.exists(book_path):
    raise FileNotFoundError("Файл 'book.txt' не найден. Убедитесь, что он находится в рабочей директории.")
...
# Загрузка модели с GPU и квантованием
if device == "cuda":
...
# Вопросы по "Критике чистого разума"
questions = [
